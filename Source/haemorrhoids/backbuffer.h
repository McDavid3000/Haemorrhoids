...
public:
	...
	void DrawDebugCircles(Vector2 centre, float radius);
	...
	void DrawRotatingAnimatedSprite(AnimatedSprite & animatedSprite, int centreX, int centreY);
	void DrawShrinkingSprite(Sprite& sprite);
